...
<body>
    ...
    <input type="submit" name="submit"><hr>   </center>
    <br>
...
$pp=$_POST['pp'];
$prod=$_POST['prod'];
$sql="INSERT INTO `data`(`nama`,`nis`,`mtk`, `indo`, `pipas`, `sunda`, `pp`, `prod`) VALUES ('$_POST[nama]','$_POST[nis]','$_POST[mtk]','$_POST[indo]','$_POST[pipas]','$_POST[sunda]','$_POST[pp]','$_POST[prod]')";
